...
import com.capstone.JobR.category.avgspec.AvgSpecActivity;

import java.util.ArrayList;

public class AvgSpecAdapter extends RecyclerView.Adapter<AvgSpecAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context.getApplicationContext(), AvgSpecActivity.class);
                //게시글 다음 화면에 넘겨주기
                intent.putExtra("companyName", companyName.getText().toString());
                //화면 전환
                context.startActivity(intent);
                Toast.makeText(context.getApplicationContext(), companyName.getText() + " 의 스펙차트", Toast.LENGTH_SHORT).show();
            });
        }
