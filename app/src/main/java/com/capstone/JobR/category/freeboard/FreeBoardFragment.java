package com.capstone.JobR.category.freeboard;
...
public class FreeBoardFragment extends Fragment {
    ...
    private void init(String id) {
        ...
        fragments.add(new BoardFragment("자유게시판", id));
        fragments.add(new BoardFragment("질문-답변", id));
        fragments.add(new BoardFragment("고민-상담", id));
        fragments.add(new BoardFragment("유머방", id));
        fragments.add(new BoardFragment("이것이 알고싶다", id));
