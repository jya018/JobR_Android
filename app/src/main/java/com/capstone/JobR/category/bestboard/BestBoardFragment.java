package com.capstone.JobR.category.bestboard;
...
public class BestBoardFragment extends Fragment {
    ...
    private void init(String id) {
        ...
        fragments.add(new BoardFragment("베스트 게시글",id));
        fragments.add(new BoardFragment("공지사항",id));
        fragments.add(new BoardFragment("전체 게시글",id));
