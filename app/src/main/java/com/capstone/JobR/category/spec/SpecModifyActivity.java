...
public class SpecModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spec_modify);
        ...
        //값 설정
        spec = (SpecVO) getIntent().getSerializableExtra("spec");
        ...
        internTrue.setChecked(spec.isIntership());
        internFalse.setChecked(!spec.isIntership());
