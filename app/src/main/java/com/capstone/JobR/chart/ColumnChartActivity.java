package com.capstone.JobR.chart;
...
public class ColumnChartActivity extends Fragment {
    ...
    public ColumnChartActivity() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        setHasOptionsMenu(true);
        View rootView = inflater.inflate(R.layout.item_spec_chart, container, false);

        specTitle = rootView.findViewById(R.id.specTitle);

        chart = (ColumnChartView) rootView.findViewById(R.id.chart);
        chart.setOnValueTouchListener(new ValueTouchListener());

        specTitle.setOnClickListener(v -> {
            if (chart.getVisibility() == View.VISIBLE) {
                chart.setVisibility(View.GONE);
                specTitle.animate().setDuration(200).rotation(0f);
            } else {
